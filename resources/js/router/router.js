...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "machine/create", // New route for Factory
        name: "MechineCreate",
        component: adminComponents.MechineCreate,
        meta: { title: "Machine Create" },
      },
      {
        path: "machine/:uuid/edit", // Dynamic route for Factory Edit
        name: "MechineEdit",
      ...
      {
        path: "machine/:uuid/transfer",
        name: "MechineTransfer",
        component: adminComponents.MechineTransfer,
        meta: { title: "Machine Transfer" },
        props: true,
      },
      {
        path: "machine/trash", // New route for Contact
        name: "MechineTrash",
        component: adminComponents.MechineTrash,
        meta: { title: "Machine Trash" },
      },
      ...
      {
        path: "machine/type/index", // New route for machine type index
      ...
      {
        path: "machine/type/create", // New route for machine type index
      ...
      {
        path: "machine/type/edit/:uuid", // New route for machine type index
      ...
      {
        path: "machine/type/trash", // New route for floor trash
      ...
      {
        path: "machine/source/index", // New route for machine source index
      ...
      {
        path: "machine/source/trash", // New route for Source trash
