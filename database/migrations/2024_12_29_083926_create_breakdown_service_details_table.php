...
return new class extends Migration
{
    ...
    {
        Schema::create('breakdown_service_details', function (Blueprint $table) {
            $table->id();
            ...
            // Foreign key assign
            $table->foreignId('breakdown_service_id');
            $table->foreignId('technician_id')->nullable();

            // Foreign key References
            $table->foreign("breakdown_service_id")
            ->references('id')
            ->on('breakdown_services')
            ->onUpdate('cascade')
            ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('breakdown_service_details');
    }
};
